...
\begin{wout}{}
million -0.207233 3 20 224 1 [ million 139 mln 30 billion 11 ]
eight-year -3.36874 2 1623 26995 0.0103093 [ in 1866 . 1843 tonnes 1525 ]
bond -1.62325 2 17 42 0.2 [ Eurobond 11 war 10 contract 3 ]
\end{wout}

It contains the target word, the $log_{10}$ probability of the
classification, followed by the $n$ of the matching \ngram{}, the size
of the distribution, the sum of the frequencies in the distribution,
and the reciprocal rank of the target in the distribution. This is
followed by the \topn{n} of the distribution.
...
matched a four-gram, that means the whole sequence \cmp{<s> The
  Carlyle Group} was found in the training data. The difference is
most likely due to \emph{smoothing} and \emph{hapaxing}, which is done
by \srilm{} but not by \wopr{}.

\subsection{Another One}

The following comparison is a three-way one. We compare an \igtree{}
instance base with a \wopr{} trigram model and an \srilm{} trigram
model. 
