...
"""
Takes a windowed data set and a confusible file. Version 2 without expanding to caps.
...
Examples:
python2.7 split_data_confusibles2.py -f utexas.10e6.dt.cf05.1e6.l4t1r4 -c preps_hoo2013.txt -t "-a1 +D" -w "wopr" -i
