...
echo "plot \"$MEM_FILE\" using 1:2 with lines,\\" >> $PLOTFILE
echo "\"$MEM_FILE\" using 1:3 with lines,\\" >> $PLOTFILE
echo "\"$MEM_FILE\" using 1:(column(3)-column(2)) with lines" >> $PLOTFILE
#
# --
#
